...
export const ContentTabs: React.FC<ContentTabsProps> = ({ 
  ...
  const tabs = [
    { id: 'armor' as TabType, name: 'Equipment', icon: <Shield size={16} className="text-purple-400" /> },
    { id: 'spells' as TabType, name: 'Spells', icon: <Zap size={16} className="text-purple-400" /> }
  ];
